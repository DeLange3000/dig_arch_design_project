    ...
    if(output_selector = "0000") then an <= "1111";
            ...
            case switch is
                when "00" => switch <= "01";
                    ...
                    when "0101" => inputs <= output_array(79 downto 76);
                    when "0110" => inputs <= output_array(63 downto 60);
                    when "0111" => inputs <= output_array(47 downto 44);
                    when "1000" => inputs <= output_array(31 downto 28);
                    when "1001" => inputs <= output_array(15 downto 12);
                ...
                case output_selector is
                    ...
                    when "0101" => inputs <= output_array(75 downto 72);
                    when "0110" => inputs <= output_array(59 downto 56);
                    when "0111" => inputs <= output_array(43 downto 40);
                    when "1000" => inputs <= output_array(27 downto 24);
                    when "1001" => inputs <= output_array(11 downto 8);
                    when others => inputs <= x"0";
                    end case;
                when "10" => switch <= "11";
                an <= "1101";
